...
Aplicación Next.js para crear itinerarios personalizados con Gemini. El acceso de usuarios se realiza con Google OAuth y la clave de Gemini permanece en el servidor.
