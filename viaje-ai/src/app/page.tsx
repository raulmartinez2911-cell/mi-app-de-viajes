...
function Landing({ authenticated, loading, onContinue }: { authenticated: boolean; loading?: boolean; onContinue: () => void }) {
  return <section className="intro landing-screen" id="top">
    <div className="landing-content">
      <div className="landing-brand-media"><Image className="landing-logo" src="/Rumbo.png" alt="Rumbo" width={1200} height={183} priority /><div className="landing-video" aria-hidden="true"><video autoPlay muted loop playsInline poster="/Rumbo.png"><source src="/SVD-img2vid_video.mp4" type="video/mp4" /></video></div></div>
